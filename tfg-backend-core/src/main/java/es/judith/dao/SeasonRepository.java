...
public interface SeasonRepository
    ...
    @Query("SELECT s FROM Season s LEFT JOIN FETCH s.episodes e LEFT JOIN FETCH s.show h")
    List<Season> findAll();
    @Query("SELECT s FROM Season s LEFT JOIN FETCH s.episodes e LEFT JOIN FETCH s.show h WHERE s.id = :id")
